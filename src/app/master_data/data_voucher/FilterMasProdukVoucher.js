...
export default function FilterMasProdukVoucher({
  isOpenFilter,
  onChangeFilter,
}) {
    ...
    >
      <div className="flex gap-3 w-full">
        ...
        <EvoInDropdown
          ...
          options={[
            { label: 'Voucher Silver', value: 'silver' },
            { label: 'Voucher Gold', value: 'gold' },
            { label: 'Voucher Platinum', value: 'platinum' },
            { label: 'Voucher Corporate', value: 'corporate' },
            { label: 'Voucher VIP', value: 'vip' },
          ]}
          value={selectedOptions.produkVoucher}
          onChange={handleDropdownChange}
          placeholder="Pilih produk Voucher"
          className="basis-full"
        />
      </div>
