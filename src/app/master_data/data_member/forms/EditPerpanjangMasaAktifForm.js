...
const EditPerpanjangMasaAktifForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    const newErrors = {
      ...
      // periode:
      //   !Array.isArray(formData.periode) ||
      //   formData.periode.length < 2 ||
      //   formData.periode.some((p) => !p)
      //     ? 'Periode wajib ditentukan dahulu'
      //     : '',
    ...
    <>
      ...
      >
        ...
        >
          ...
          <br />
          formData.produk_id: {formData.produk_id || ''}
          <br />
          formData.tarif: {formData.tarif || ''}
          <br />
          formData.periode: {formData.periode || ''} 
          <br />
