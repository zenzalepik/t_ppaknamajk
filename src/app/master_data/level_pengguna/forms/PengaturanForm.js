...
import { fetchApiMasterDataLevelPenggunaUpdate } from '../api/fetchApiMasterDataLevelPenggunaUpdate';
import { RiUser3Line, RiBuildingLine } from '@remixicon/react';

const PengaturanLevelPenggunaForm = ({
  isOpen,
  onClose,
  onSubmit,
  initialData = null,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await fetchApiMasterDataLevelPenggunaUpdate(finalData);
  ...
  return (
    <>
      ...
      <EvoModal
        ...
        title="Pengaturan Level Pengguna"
      ...
      >
        ...
        >
          <div className="bg-black rounded-[24px] p-4 flex flex-col gap-4">
          <div>
            <label className="text-card text-white mb-1">Nama Level Pengguna:</label>
            <div className="text-title_small flex w-full gap-3 py-4 px-3.5 rounded-[16px] border-0 border-dashed bg-white/10 justify-start items-center text-primary">
              <RiUser3Line size={28} className="text-primary" />
              {formData.nama || '-'}
            </div>
          </div>

          <div className="">
            <label className="text-card text-white mb-1">Perusahaan:</label>
            <div className="text-title_small flex w-full gap-3 py-4 px-3.5 rounded-[16px] border-0 border-dashed bg-white/10 justify-start items-center text-primary/[0.8]">
              <RiBuildingLine size={28} className="text-primary" />
...
export default PengaturanLevelPenggunaForm;
