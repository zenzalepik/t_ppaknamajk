...
import dataCheckBoxLevelPenggunaAdministratorTenant from '@/app/master_data/level_pengguna/data/dataCheckBoxLevelPenggunaAdministratorTenant';
...
const AddLevelPenggunaForm = ({
  ...
  // 🔹 Isi otomatis jika perusahaanId ada
  useEffect(() => {
    if (perusahaanId) {
      setFormData((prev) => ({
        ...prev,
  ...
  const handleCloseModal = () => {
    setFormData((prev) => ({
      ...prev,
      nama: '',
      perusahaan_id: hakAkses == 'Administrator Tenant' ? perusahaanId : '',
      // user_id: null,
    }));
  ...
  const dataCheckBox =
    hakAkses === 'Administrator Tenant'
      ? dataCheckBoxLevelPenggunaAdministratorTenant
      : hakAkses === 'Super Admin'
      ? dataCheckBoxLevelPengguna
      : dataCheckBoxLevelPengguna;

  const buildFullHakAkses = () => {
    return dataCheckBox.map((menu) => {
  ...
  const rows = dataCheckBox.flatMap((menu) => {
      ...
      >
        ...
        >
          ...
          <EvoInDropdown
            ...
            // disabled={hakAkses == 'Administrator Tenant' ? true : false}
