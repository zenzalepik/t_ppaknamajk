...
import { fetchApiPengaturanParameterInterfaceUpdate } from '../api/fetchApiPengaturanParameterInterfaceUpdate';
import { useQueryClient } from '@tanstack/react-query';

const EditInterfaceForm = ({
  isOpen,
  onClose,
  onSubmit,
  initialData=null
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setFormData({
        id: initialData.id || '',
        nama_interface: initialData.nama || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
          await fetchApiPengaturanParameterInterfaceUpdate(formData);
  ...
  return (
    <>
      ...
      <EvoModal
        ...
        title="Ubah Nilai Parameter Interface"
      >
        <EvoForm
        ...
        >
          {/* <div className="border-2 border-primary rounded-[20px] p-4">
            ...
            <div className="text-title_small">{formData.nama_interface}</div>
          </div> */}
          ...
          <div className="mx-4">
            <EvoInText
              ...
              placeholder="Masukkan nama nama interface"
