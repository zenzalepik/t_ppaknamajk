...
import { fetchApiPengaturanParameterManlessUpdate } from '../api/fetchApiPengaturanParameterManlessUpdate';
import { useQueryClient } from '@tanstack/react-query';

const EditManlessForm = ({
  isOpen,
  onClose,
  onSubmit,
  initialData=null
  ...
  const handleSubmit = async (e) => {
    ...
    try {
          await fetchApiPengaturanParameterManlessUpdate(formData);
  ...
  return (
    <>
      ...
      <EvoModal
        ...
        title="Ubah Nilai Parameter Manless"
      >
        <EvoForm
        ...
        >
          {/* <div className="border-2 border-primary rounded-[20px] p-4">
            ...
            <div className="text-title_small">{formData.tipe_manless}</div>
          </div> */}
          ...
          <div className="mx-4">
            <EvoInText
              ...
              placeholder="Masukkan nama tipe manless"
...
export default EditManlessForm;
