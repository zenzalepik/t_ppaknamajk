    ...
    >
      ...
      <div className="flex items-center space-x-4">
        ...
        >
          ...
          <span className="text-label_medium_semibold">{strings.userName}</span>
          <RiArrowDownSLine
            size={14}
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-50 bg-black/30 flex items-center justify-center">
          <div className="bg-white p-6 rounded-[40px] shadow-lg w-[360px]">
            <h2 className="text-title_small mb-2 text-center uppercase">Konfirmasi Logout</h2>
            <p className="text-center text-article text-black/[0.64] mb-6">Apakah Anda yakin ingin keluar?</p>
